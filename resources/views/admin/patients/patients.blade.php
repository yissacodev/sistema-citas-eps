...
<div class="container-fluid welcome">
    <div class="row p-3 d-flex justify-content-center align-items-center">
        <div class="col-10 fw-bold">
            ...
            <p class="welcome_text m-0">Usted puede buscar paciente digitando su cédula, nombré, apellido o cualquier dato</p>
            <p class="welcome_text">Gestione cada item con las opciones de la columna de <strong>Opciones</strong></p>
        </div>
        <a href="{{route('admin.patients.register')}}" type="button" class="btn btn-success">

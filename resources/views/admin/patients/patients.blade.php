...
<div class="container-fluid welcome">
    <div class="row p-3 d-flex justify-content-center align-items-center">
        ...
        {{-- <a href="{{route('admin.patients.register')}}" type="button"
            class="btn btn-success col-md-2 col-4 btn_add">
            <i class="fas fa-plus mr-2"></i>
            Crear Paciente
        </a> --}}
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-3 col-sm-6 col-12">
                                    ...
                                    <input class="form-control" list="datalistOptions" name="department" id="department"
                                        placeholder="Escriba una palabra" required>
                                ...
                                <div class="form-group col-md-3 col-sm-6 col-12">
                                    ...
                                    <input class="form-control" list="datalistOptions1" name="municipality"
                                        id="municipality" placeholder="Escriba una palabra" required>

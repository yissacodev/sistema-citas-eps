        ...
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content p-2">
                    <form action="{{url('admin/medic/create')}}" enctype="multipart/form-data" method="post" class="needs-validation add-form" name="add-form" novalidate>
                        ...
                        <h4>Información básica</h4>
                            ...
                            <div class="row flex-sm-row flex-column">
                                ...
                                <div class="form-group col-sm-6 col-12">
                                    ...
                                    <input type="text" name="idnumber" id="idnumber" class="form-control" pattern="[0-9]*" placeholder="Ej. 222222222" required>
                                    <div class="valid-feedback">Campo correcto</div>
                                    <div class="invalid-feedback">Campo incorrecto</div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-4 col-sm-4 col-12">
                                    ...
                                    min="1900-01-01" max="2022-07-01" required>
                                    <div class="valid-feedback">Campo correcto</div>
                                    <div class="invalid-feedback">Campo incorrecto</div>
                                </div>
                                <div class="form-group col-md-3 col-sm-4 col-12">
                                    <label for="stratrum">Estrato</label>
                                    <input type="number" min="0" max="6" name="stratrum" id="stratrum" class="form-control" 
                                    pattern="[0-6]" placeholder="Ej. 2" required>
                                </div>
                                <div class="form-group col-md-3 col-sm-4 col-12">
